...
import CAQRPairModal from "./CAQRPairModal.vue";
    ...
    >
        ...
        >
            <div class="instruction">
                ...
                <br /> <br />
                Once scanned, the certificate file will downloaded. You 
                still need to manually install the cerificate on your phone.
